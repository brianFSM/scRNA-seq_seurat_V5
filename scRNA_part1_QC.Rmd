...
run.soupx <- config.args$analysis$part1$run_SoupX
...
save_png_plot(p_nCount, "nCount_RNA_distribution.png", ggplot.directory)
```
...
p_nFeature
save_png_plot(p_nFeature, "nFeature_RNA_distribution.png", ggplot.directory)
```
...
p_percent_mt
save_png_plot(p_percent_mt, "percent_mt_distribution.png", ggplot.directory)
```
...
p_percent_hb
save_png_plot(p_percent_hb, "percent_hb_distribution.png", ggplot.directory)
...
p_percent_ribo
save_png_plot(p_percent_ribo, "percent_ribo_distribution.png", ggplot.directory)
...
p_percent_y
save_png_plot(p_percent_y, "percent_y_distribution.png", ggplot.directory)
```
