...
## clustering
```{r inefficient_silhouette, eval=FALSE}
################################################################################
...
silhouette_scores <- sapply(results, function(x) x$silhouette)
best_idx <- which.max(silhouette_scores)
best_res <- results[[best_idx]]$resolution  # pull from the list, not from names()
...
# p1_post <- DimPlot(seurat5.obj.integrated, reduction = "umap.postint", 
#                    group.by = "sample_id", label = FALSE)
# 
# p2_post <- DimPlot(seurat5.obj.integrated, reduction = "umap.postint", 
#                    group.by = clustering.resolution, label = TRUE)
# 
# save_png_plot(p1_post, "umap_sample_post_integration.png", ggplot.directory, width = 8, height = 6)
# save_png_plot(p2_post, "umap_condition_post_integration.png", ggplot.directory, width = 8, height = 6)
